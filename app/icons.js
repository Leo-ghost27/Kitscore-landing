...
const ICON_PATHS = {
  ...
  camera: '<path d="M4 8a2 2 0 0 1 2-2h1.2l1-1.6A1 1 0 0 1 9 4h6a1 1 0 0 1 .85.5L17 6h1a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V8z"/><circle cx="12" cy="13" r="3.3"/>',
  ...
  sparkles: '<path d="M12 3l1.5 4.5L18 9l-4.5 1.5L12 15l-1.5-4.5L6 9l4.5-1.5z"/><path d="M19 14.5l.6 1.7 1.9.6-1.9.6-.6 1.7-.6-1.7-1.9-.6 1.9-.6z"/>',
  rocket: '<path d="M12 2c2.4 2 3.8 5.4 3.8 8.8 0 2-.5 3.5-1 4.5l-2.8 2.7-2.8-2.7c-.5-1-1-2.5-1-4.5C8.2 7.4 9.6 4 12 2z"/><path d="M9.2 14.8l-2.6.9.9-2.6"/><path d="M14.8 14.8l2.6.9-.9-2.6"/><circle cx="12" cy="9" r="1.4"/>',
  'shield-check': '<path d="M12 2.3l7.3 3.4v5.2c0 4.5-3.1 7.3-7.3 8.8-4.2-1.5-7.3-4.3-7.3-8.8V5.7z"/><path d="M9 12l2 2 4-4"/>',
  'shield-star': '<path d="M12 2.3l7.3 3.4v5.2c0 4.5-3.1 7.3-7.3 8.8-4.2-1.5-7.3-4.3-7.3-8.8V5.7z"/><path d="M12 7.3l1 2.1 2.3.3-1.7 1.6.4 2.3-2-1.1-2 1.1.4-2.3-1.7-1.6 2.3-.3z"/>',
  'plug-connected': '<path d="M9 2.5v3.5"/><path d="M15 2.5v3.5"/><path d="M6 8.5h12v2.5a6 6 0 0 1-12 0z"/><path d="M9 17.5V21"/><path d="M15 17.5V21"/>',
  'chart-pie': '<path d="M12 2v10l7.4 6.4A10 10 0 0 0 12 2z"/><path d="M12 12L4.6 18.4A10 10 0 0 1 12 2z"/>',
};
