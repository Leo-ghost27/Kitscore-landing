...
const PRODUCT_CONFIG = {
  ...
  // STRIPE_PRICE_AGENCY has no value set yet -- this product is wired
  // end-to-end (checkout here, plan flip in stripe-webhook.js, upgrade
  // button on profile-manager.html) but stays inert ("Unknown or
  // unconfigured product", same as any other product with no price set)
  // until an actual Agency-tier recurring Price is created in Stripe and
  // STRIPE_PRICE_AGENCY is set in the Vercel env. That price point is a
