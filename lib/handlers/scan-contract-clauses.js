...
// one-sided indemnification/liability language (see
// lib/contract-clause-scan.js for the full design note and the explicit
// non-legal-advice framing that must be preserved in any UI built on
// this). Callable by either party on the contract (or admin) -- unlike
// disclosure_scans this isn't gated to admin-only, because it's the
// creator's own legal exposure and the whole point is surfacing it
// immediately, not after an admin review queue.
//
