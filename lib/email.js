...
function rosterInviteEmail({ managerLabel, acceptLink }) {
  return {
    subject: `${managerLabel} invited you to join their roster on Kitscore`,
    text: `${managerLabel} has invited you to join their creator roster on Kitscore.\n\nAccept: ${acceptLink}\n\nExpires in 14 days.`,
    html: `
      <div style="font-family:-apple-system,sans-serif;max-width:480px;margin:0 auto;padding:24px">
        <h2 style="font-size:18px;color:#1A1A1E">You're invited to join ${escapeHtml(managerLabel)}'s roster</h2>
        <p style="color:#6B7280;font-size:14px">${escapeHtml(managerLabel)} has invited you to join their creator roster on Kitscore, the creator trust and verification platform.</p>
        <a href="${acceptLink}" style="display:inline-block;margin:16px 0;padding:10px 20px;background:#2563EB;color:#fff;text-decoration:none;border-radius:6px;font-size:14px;font-weight:500">Accept invite</a>
        <p style="color:#9CA3AF;font-size:12px">This link expires in 14 days. You can revoke this from your Profile at any time after accepting.</p>
      </div>`,
  };
}

module.exports = { sendEmail, teamInviteEmail, sponsorReceiptEmail, reportReadyEmail, refundConfirmationEmail, disputeNotificationEmail, campaignConfirmInviteEmail, sponsorInviteCreatorEmail, creatorInviteSponsorContractEmail, brandSafetyFlagEmail, disclosureFlagEmail, escrowFundedEmail, escrowDeliverableSubmittedEmail, escrowReleasedEmail, escrowDisputedCreatorEmail, escrowDisputedAdminEmail, escrowStuckNudgeEmail, contractFlaggedSponsorEmail, contractFlaggedCreatorEmail, repitchNudgeEmail, verificationRequestEmail, managerInviteEmail, agencyStaffInviteEmail, watchlistAvailabilityEmail, trialEndingEmail, rosterInviteEmail };
