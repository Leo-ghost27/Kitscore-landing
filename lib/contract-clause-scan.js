...
// rights, exclusivity, additional terms) for two categories of red flag:
//
...
async function scanContractClauses(contract) {
  ...
  const prompt = `You are helping an individual content creator understand a sponsorship contract's terms before they sign. Read the contract text below and identify any language matching either category:
