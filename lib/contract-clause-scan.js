...
// rights, exclusivity, additional terms) for indemnification or
// liability language that shifts third-party legal exposure onto the
// creator disproportionately -- e.g. the creator agrees to indemnify the
// sponsor against claims arising from the sponsor's own product, or is
// made liable for a compliance failure (like a missing FTC disclosure)
// that the sponsor's own brief or approval process contributed to.
//
...
// dangerous, only that it reads as one-sided and may be worth review.
// This framing must be preserved in any UI copy built on top of this.
...
async function scanContractClauses(contract) {
  ...
  const prompt = `You are helping an individual content creator understand a sponsorship contract's terms before they sign, specifically looking for indemnification or liability language that shifts legal risk onto them disproportionately.

Read the contract text below and identify any language where:
